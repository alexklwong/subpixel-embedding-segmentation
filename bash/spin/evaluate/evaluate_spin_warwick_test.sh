...
--multimodal_scan_paths testing/warwick/traintest/warwick_test_scans.txt \
--ground_truth_path testing/warwick/traintest/warwick_test_ground_truths.txt \
...
--checkpoint_path evaluation_results/spin/spin_warwick_traintest \
--restore_path trained_spin_models/warwick/spin_traintest/model-44000.pth \
--device gpu \
--n_thread 8
