...
--train_multimodal_scan_paths training/warwick/traintest/warwick_train_scans.txt \
--train_ground_truth_path training/warwick/traintest/warwick_train_ground_truths.txt \
--val_multimodal_scan_paths testing/warwick/traintest/warwick_test_scans.txt \
--val_ground_truth_path testing/warwick/traintest/warwick_test_ground_truths.txt \
--n_batch 8 \
--n_chunk 1 \
--n_height 128 \
--n_width 128 \
...
--n_checkpoint 500 \
--checkpoint_path \
trained_spin_models/warwick/spin_traintest \
--device gpu \
--n_thread 8