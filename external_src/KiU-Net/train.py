...
from metrics import jaccard_index, f1_score, LogNLLLoss,classwise_f1,dice_score
...
model.load_state_dict(torch.load("trained_model/trial2/14/kiunet.pth"))
...
metric_list = MetricList({'dice':partial(dice_score)})
