...
class GenericUNetTrainingDataset(torch.utils.data.Dataset):
    '''
...
class GenericUNetInferenceDataset(torch.utils.data.Dataset):
    '''
    Dataset for U-Net to fetch entire scan volumes (supports multimodal)
